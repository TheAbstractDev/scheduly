...
- `docker run --rm -ti -p 8080:8080 -v "$PWD":/usr/src/app --net host scheduly npm install`
...
### Run
- `docker run --rm -ti -p 8080:8080 -v "$PWD":/usr/src/app --net host node:onbuild npm install`
